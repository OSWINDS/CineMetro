...
final class DbAdapter {
    ...
    private void populateDB() {
        ...
        this.db.addRoute(new Route("Η Θεσσαλονίκη μέσα απο τον ελληνικό κινηματογράφο", "blue", 1));
        ...
        this.db.addStation(new Station("Κέντρο 2 (Καμάρα - Ναυαρίνο)",
                "Στο κέντρο της Θεσσαλονίκης υπήρξαν αρκετοί κινηματογράφοι που για χρόνια αποτέλεσαν σημείο αναφοράς στην " +
                        ...
                        "\n" +
                        "Ενδεικτική αναφορά μερικών σινεμά που αφορούν την ευρύτερη περιοχή: Ηλύσια, Ναυαρίνο, Έλση, Κλειώ, Ριβολί, Θυμέλη," +
                        " Φαργκάνη. \n" +
                        "\n" +
        ...
        this.db.addStation(new Station("Λευκός Πύργος",
                "Από το 1905 ο κήπος του Λευκού Πύργου φιλοξενούσε αίθουσα κινηματογράφου. \n" +
                        "\n" +
                        "Εδώ βρίσκεται η Εταιρεία Μακεδονικών Σπουδών (ΕΜΣ), παλιά έδρα του Φεστιβάλ Κινηματογράφου Θεσσαλονίκης και " +
                        ...
                        "\n" +
                        "Στον Αλέξανδρο φιλοξενούνται κάθε Οκτώβριο οι προβολές του Thessaloniki International Short Film Festival " +
                        "(TISFF).\n" +
                        "\n" +
        ...
        this.db.addStation(new Station("Κάτι να καίει (1964)",
                "Σκηνοθεσία: Γιάννης Δαλιανίδης\n" +
                        ...
                        "\n" +
                        "Πρώτη κινηματογραφική εμφάνιση για την 17χρόνη (τότε) Έλενα Ναθαναήλ.",
                2, 40.628192, 22.9561));
        ...
        this.db.addStation(new Station("Χώρα προέλευσης (2010)",
                "Σκηνοθεσία: Σύλλας Τζουμέρκας\n" +
                        ...
                        "\n" +
                        "Συμμετοχή στην Εβδομάδα Κριτικής του 67ου Φεστιβάλ Βενετίας.",
        ...
        this.db.addMovie(new Movie(8, "Το ξυπόλητο τάγμα (1955)",
                "Η αληθινή ιστορία επιβίωσης 160 παιδιών στην Θεσσαλονίκη της Κατοχής. \n" +
                        ...
                        "\n" +
                        "Χρυσό Βραβείο στο Φεστιβάλ Κινηματογράφου του Εδιμβούργου (1955).",
                "Μαρία Κωστή, Νίκος Φέρμας, Βασίλης Φραγκεδάκης",
                "Γκρεγκ Τάλλας", "1955"));
        ...
        this.db.addMovie(new Movie(10, "Κάτι να καίει (1964)",
                "Ένα νεανικό μουσικό συγκρότημα, ένας προσωπάρχης που συνοδεύει την κόρη του αφεντικού του στη Θεσσαλονίκη, μια κληρονομιά που περιμένει έναν γάμο. Μια παρέα νέων ανθρώπων σε αστείες και ρομαντικές περιπέτειες. \n" +
                        ...
                        "\n" +
                        "Πρώτη κινηματογραφική εμφάνιση για την 17χρόνη (τότε) Έλενα Ναθαναήλ.",
                "Ρένα Βλαχοπούλου, Ντίνος Ηλιόπουλος, Μάρθα Καραγιάννη, Έλενα Ναθαναήλ, Κώστας Βουτσάς",
        ...
        this.db.addMovie(new Movie(14, "Χώρα Προέλευσης (2010)", "Οικογενειακό δράμα ως ακτινογραφία της νεοελληνικής κοινωνικής πραγματικότητας. \n" +
                ...
                "\n" +
                "Συμμετοχή στην Εβδομάδα Κριτικής του 67ου Φεστιβάλ Βενετίας.",
                "Αμαλία Μουτούση, Θάνος Σαμαράς, Ιωάννα Τσιριγκούλη",
        ...
        this.db.addMovie(new Movie(15, "Σούπερ Δημήτριος (2011)", "Όταν ο Κάπτεν Φ.Ρομ, απαιτώντας να τον φωνάζουν με το πραγματικό του " +
                ...
                "\n" +
                "Βραβείο κοινού στο Φεστιβάλ Κινηματογράφου Θεσσαλονίκης.",
                "Δημήτρης Βαϊνάς, Πάρης Παπαδόπουλος, Όλγα Σφέτσα",
        ...
        this.db.addMilestone(new Milestone(4, "1997", "Η πλήρης ανακαίνιση του Ολύμπιον έγινε στο πλαίσιο της Πολιτιστικής Πρωτεύουσας " +
                "της Ευρώπης «Θεσσαλονίκη ΄97».", "olympion38filmfestival",
